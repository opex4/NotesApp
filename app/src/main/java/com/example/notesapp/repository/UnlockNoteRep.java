...
@Getter
public class UnlockNoteRep extends Rep<Void> {
    private int noteId;
    private MutableLiveData<String> successMessage = new MutableLiveData<>();
    public UnlockNoteRep(String jwtToken, int noteId){
        super(jwtToken);
        this.noteId = noteId;
    }
    ...
    public void pullData() {
        ...
        Call<Void> call = apiService.unlockNote(super.getJwtToken(), noteId);
    ...
    public void handleSuccessResponse(Void responseData, int code) {
        if(code == 200){
            successMessage.postValue("Записка разблокирована");
        }
    }
    ...
    public void handleErrorResponse(int code){
        ...
        switch (code) {
            case 401:
                ...
                break;
            case 403:
                errorMessage = "Файл не заблокирован или заблокирован другим пользователем";
                break;
            case 404:
